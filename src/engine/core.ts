...
import type { BibEntry, Check, SourceResult, VerificationResult } from "./types";
import { matchTitle, matchAuthors, matchYear, matchVenue, tokenSimilarity, extractFirstSurname } from "./matching";
import { queryArxiv } from "./sources/arxiv";
import { queryCrossref } from "./sources/crossref";
import { queryDblp } from "./sources/dblp";
import { queryS2 } from "./sources/s2";
import { queryOpenAlex } from "./sources/openalex";
